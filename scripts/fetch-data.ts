...
async function main() {
  ...
  const feeds = await Promise.all([
    ...
    fetchRSS('https://www.spa.gov.sa/rss/en/all', 'SPA (Saudi)', 'https://www.google.com/s2/favicons?domain=spa.gov.sa&sz=32', 'https://spa.gov.sa', 'government'),
    // Local / Regional Media
    fetchRSS('https://www.khaleejtimes.com/feed', 'Khaleej Times', 'https://www.google.com/s2/favicons?domain=khaleejtimes.com&sz=32', 'https://khaleejtimes.com', 'local_media'),
    fetchRSS('https://gulfnews.com/cmlink/all-rss', 'Gulf News', 'https://www.google.com/s2/favicons?domain=gulfnews.com&sz=32', 'https://gulfnews.com', 'local_media'),
    fetchRSS('https://www.thenationalnews.com/arc/outboundfeeds/rss/', 'The National', 'https://www.google.com/s2/favicons?domain=thenationalnews.com&sz=32', 'https://thenationalnews.com', 'local_media'),
    fetchRSS('https://www.arabnews.com/cat/1/rss.xml', 'Arab News', 'https://www.google.com/s2/favicons?domain=arabnews.com&sz=32', 'https://arabnews.com', 'local_media'),
    ...
    fetchRSS('https://english.alarabiya.net/News/rss.xml', 'Al Arabiya', 'https://www.google.com/s2/favicons?domain=alarabiya.net&sz=32', 'https://english.alarabiya.net', 'local_media'),
    fetchRSS('https://www.middleeasteye.net/rss/feed', 'Middle East Eye', 'https://www.google.com/s2/favicons?domain=middleeasteye.net&sz=32', 'https://middleeasteye.net', 'local_media'),
    fetchRSS('https://kyivindependent.com/rss', 'Kyiv Independent', 'https://www.google.com/s2/favicons?domain=kyivindependent.com&sz=32', 'https://kyivindependent.com', 'local_media'),
